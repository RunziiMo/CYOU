...
public class DemoDBManager {
    ...
    private DemoDBManager() {
        dbHelper = DbOpenHelper.getInstance(CYouApplication.getInstance().getApplicationContext());
    }
    ...
    synchronized public void saveContactList(List<EaseUser> contactList) {
        ...
        if (db.isOpen()) {
            ...
            for (EaseUser user : contactList) {
                ...
                if (user.getSingature() != null)
                    values.put(UserDao.COLUMN_NAME_SIGN, user.getSingature());
    ...
    synchronized public void saveRobotList(List<RobotUser> robotList) {
        ...
        if (db.isOpen()) {
            ...
            for (RobotUser item : robotList) {
                ...
                if (item.getSingature() != null)
                    values.put(UserDao.ROBOT_COLUMN_NAME_SIGN, item.getSingature());
    ...
    synchronized public Map<String, RobotUser> getRobotList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                String signature = cursor.getString(cursor.getColumnIndex(UserDao.ROBOT_COLUMN_NAME_SIGN));
