...
import com.runzii.cyou.common.utils.DemoHelper.DataSyncListener;
import com.runzii.cyou.common.utils.PreferenceManager;
...
public class UserProfileManager {
    ...
    public synchronized EaseUser getCurrentUserInfo() {
        if (currentUser == null) {
            ...
            String signature = getCurrentUserSignature();
            currentUser.setNick((nick != null) ? nick : username);
            currentUser.setAvatar(getCurrentUserAvatar());
            currentUser.setSingature(signature);
        }
        return currentUser;
    }
    ...
    public boolean updateCurrentUserSignature(final String signature) {
        boolean isSuccess = ParseManager.getInstance().updateParseSignature(signature);
        if (isSuccess) {
            setCurrentUserSign(signature);
        }
        return isSuccess;
    }
        ...
        ParseManager.getInstance().asyncGetCurrentUserInfo(new EMValueCallBack<EaseUser>() {
            ...
            public void onSuccess(EaseUser value) {
                if (value != null) {
                    ...
                    setCurrentUserSign(value.getSingature());
                }
            }
    ...
    private void setCurrentUserSign(String signature) {
        getCurrentUserInfo().setSingature(signature);
        PreferenceManager.getInstance().setCurrentUserSign(signature);
    }
    ...
    private String getCurrentUserSignature() {
        return PreferenceManager.getInstance().getCurrentUserSign();
    }
