...
public class PreferenceManager {
    ...
    private static String SHARED_KEY_CURRENTUSER_SIGN = "SHARED_KEY_CURRENTUSER_SIGN";
    private static String SHARED_KEY_CURRENTUSER_AVATAR = "SHARED_KEY_CURRENTUSER_AVATAR";
    private static String SHARED_KEY_CHECK_FIRSTUSE = "SHARED_KEY_CHECK_FIRSTUSE";
    ...
    public void setFirstUse(boolean firstUse) {
        editor.putBoolean(SHARED_KEY_CHECK_FIRSTUSE, firstUse);
        editor.commit();
    }

    public boolean isFirstUse() {
        return mSharedPreferences.getBoolean(SHARED_KEY_CHECK_FIRSTUSE, true);
    }
    ...
    public void setCurrentUserSign(String sign) {
        editor.putString(SHARED_KEY_CURRENTUSER_SIGN, sign);
        editor.commit();
    }
    ...
    public String getCurrentUserSign() {
        return mSharedPreferences.getString(SHARED_KEY_CURRENTUSER_SIGN, null);
    }
    ...
    public void removeCurrentUserInfo() {
        ...
        editor.remove(SHARED_KEY_CURRENTUSER_SIGN);
        editor.commit();
    }
}
